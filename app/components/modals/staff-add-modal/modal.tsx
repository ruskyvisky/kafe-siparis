      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md transform transition-all">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between bg-gray-50 rounded-t-xl px-6 py-4">
            <h3 className="text-xl font-medium text-gray-900">Yeni Personel Ekle</h3>
            <button 
              type="button"
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  placeholder="Personel soyismi girin"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  placeholder="Görev pozisyonunu girin"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  placeholder="Maaş bilgisini girin"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                />
              </div>
            </div>
